...
import foo.starred.snowbird.utils.serialize
...
open class AbstractJsonStore(private val name: String, private val path: String, private val tts: Int = 5) {
    ...
    fun load(): JsonObject {
        ...
        root = try {
            ...
            Snowbird.LOGGER.error("Failed to load scribbled file for $name at $path: $e")
            JsonObject()
        }
