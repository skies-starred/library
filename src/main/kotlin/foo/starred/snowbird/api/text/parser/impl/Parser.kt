package foo.starred.snowbird.api.text.parser.impl

import foo.starred.snowbird.api.text.parser.data.ParserState
import foo.starred.snowbird.utils.colors
import net.minecraft.network.chat.ClickEvent
import net.minecraft.network.chat.HoverEvent
import net.minecraft.network.chat.MutableComponent
import java.net.URI

fun String.parse(white: Boolean = false): MutableComponent {
    val state = ParserState(white)
    var textStart = 0
    var i = 0
    ...
    while (i < length) {
        ...
        if (lower == "r" || namedColor != null || numericColor != null) {
            ...
            if (lower != "r" && !state.white && i == 0) state.base = colorVal
